<div>
    ...
    <div class="card">
        <div class="card-header bg-info">
            <h5 class="text-center my-2"><i class="fa-solid fa-list"></i> Todos los usuarios administrativos <span class="badge badge-light"> {{$all_users}}</span></h5>
        </div>
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                ...
                                @can('admin.users.destroy')
                                    <td width="10px">
                                        <form action="{{ route('admin.users.destroy', $users) }}" method="POST" class="alert-delete">
                                            @csrf
                                            @method('delete')
